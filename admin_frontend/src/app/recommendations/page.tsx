...
// ─── Mock (future: GET /api/feedback/trainers) ────────────────────────────────
const TRAINERS: TrainerFeedback[] = [
    {
        id: "alfonso", name: "Alfonso", rating: 4.7, responses: 86, satisfaction: 94,
    ...
    {
        id: "manu", name: "Manu", rating: 4.5, responses: 74, satisfaction: 90,
...
// ─── Mock (future: GET /api/feedback/experience) ─────────────────────────────
...
const INSIGHTS = [
    ...
    "El NPS de 62 indica promotores activos; incentivar reseñas puede ampliar el alcance.",
];
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                >
                    <QrCode className="w-3.5 h-3.5" style={{ color: "#9CA3AF" }} />
                    <span className="text-[11px]" style={{ color: "#6B7280" }}>Encuestas QR</span>
                    <span className="inline-flex items-center rounded-full border px-2 py-0.5 text-[11px] font-medium bg-amber-100 text-amber-700 border-amber-200">
            Demo
          </span>
                </div>
            </div>
                ...
                <Card>
                    ...
                    <div className="flex items-center gap-6">
                        <div className="text-center flex-shrink-0">
                            <p className="text-5xl font-black" style={{ color: "#0040A0" }}>
                                {EXPERIENCE.nps}
                            </p>
                            <p className="text-xs mt-1" style={{ color: "#9CA3AF" }}>NPS global</p>
                        </div>
                        <div className="flex-1 space-y-1">
                            <p className="text-xs" style={{ color: "#374151" }}>
                                <span className="font-semibold" style={{ color: "#15803d" }}>NPS &gt; 50</span>{" "}
                                se considera excelente. El gimnasio se encuentra en zona positiva.
                            </p>
                            <p className="text-xs" style={{ color: "#6B7280" }}>
                                Basado en: &ldquo;¿Recomendarías el gimnasio UTEC a un amigo?&rdquo;
                            </p>
                        </div>
                    </div>
                </Card>
